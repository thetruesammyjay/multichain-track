...
export const FrameWrapperByAnima = (): JSX.Element => {
  ...
  const handleBridge = () => {
    const queryParams = new URLSearchParams({
      sourceChain: bridgeConfig.fromChain,
      destinationChain: bridgeConfig.toChain,
      token: bridgeConfig.token,
      amount: bridgeConfig.amount,
      env: "testnet"
    });
    window.open(`https://wormhole-foundation.github.io/wormhole-connect/?${queryParams.toString()}`, '_blank');
  };
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-[#182122] rounded-[5px] flex items-center justify-center">
                        <img
                          ...
                          alt={bridgeConfig.fromChain === "ethereum" ? "MetaMask" : "Solana"}
                          src={bridgeConfig.fromChain === "ethereum" ? "/group-34-1.png" : "/frame-1000002970.svg"}
                        />
                      </div>
                      <span className="font-['Prompt',Helvetica] font-semibold text-[#182122] text-[22px]">
                        {bridgeConfig.fromChain === "ethereum" ? "MetaMask" : "Solana"}
                      </span>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <img
                        ...
                        alt={bridgeConfig.toChain === "solana" ? "Solflare" : "MetaMask"}
                        src={bridgeConfig.toChain === "solana" ? "/frame-1000002970.svg" : "/group-34-1.png"}
                      />
                      <span className="font-['Prompt',Helvetica] font-semibold text-[#182122] text-[22px]">
                        {bridgeConfig.toChain === "solana" ? "Solflare" : "MetaMask"}
                      </span>
                    </div>
                    <ChevronDownIcon className="w-[22px] h-[22px]" />
                  </Button>
